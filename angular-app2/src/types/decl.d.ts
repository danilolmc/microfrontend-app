declare module "@app/utility" {
    ...
    export { Authentication, AuthenticationManagement, MFERoute, MFERouteObjectType, MFERoutes, SessionUserDataManagement, UserCredentials, getSession, removeSession, saveSession };
